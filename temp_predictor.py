...
# print("\n" + "="*70)
# print("Would you like to generate the complete analysis report?")
# print("="*70)
# response = input("Generate report? (yes/no): ").strip().lower()

# if response in ['yes', 'y']:
#     generate_complete_report(tp)
# Interactive prediction
    ...
    new_data = {
        "sun": 7.3,#float(input("Yesterday sun: ")),
        "soil": 8.125,#float(input("Yesterday soil: ")),
        "rain": 0,#float(input("Yesterday rain: ")),
        "gmin": 4,#float(input("Yesterday gmin: ")),
...
# new_data = {
#     "sun": get_float("Yesterday sun (hours): ", min_val=0, max_val=24),
#     "soil": get_float("Yesterday soil temp (°C): ", min_val=-20, max_val=40),
#     "rain": get_float("Yesterday rain (mm): ", min_val=0),
#     "gmin": get_float("Yesterday min ground temp (°C): ", min_val=-20, max_val=40),
#     "wdsp": get_float("Yesterday wind speed (m/s): ", min_val=0, max_val=40),
#     "maxtp_yesterday": get_float("Yesterday MAX air temp (°C): ", min_val=-20, max_val=40),
#     "mintp_yesterday": get_float("Yesterday MIN air temp (°C): ", min_val=-20, max_val=40),
#     "forecast_date": get_date("Forecast date (YYYY-MM-DD): ")
# }
